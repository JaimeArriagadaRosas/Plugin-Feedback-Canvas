    ...
    <div style={styles.wrapper}>
      ...
      <main style={styles.main}>
              ...
              <div style={styles.row}>
                ...
                <div style={styles.col}>
                  <div style={styles.statusBox}>
                    ...
                    Capa de Abstracción: Activa
                  </div>
                  <div style={{ fontSize: 11, color: "#666", marginTop: "5px" }}>Vista centralizada del panel de administración</div>
                </div>
              </div>
            </div>
              ...
              <div style={styles.col}>
                <div style={styles.card}>
                  ...
                  <div style={styles.box}>
                    ...
                    <strong>ID de Auditoría:</strong> AI55-40 (conexión con lógica de imágenes)
                  </div>
                </div>
              </div>
              <div style={styles.col}>
        ...
        <div style={{ marginTop: "30px", textAlign: "right", display: "flex", justifyContent: "flex-end", gap: "15px" }}>
          ...
          <button style={styles.btnAction}>Sincronizar y Actualizar Motor de IA Ahora</button>
        </div>
      </main>
