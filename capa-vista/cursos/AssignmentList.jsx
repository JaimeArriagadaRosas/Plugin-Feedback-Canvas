  ...
  return (
    <div style={styles.wrapper}>
      <main style={styles.main}>
        <h1 style={styles.pageTitle}>FEEDBACK PLUGIN CONFIGURATION - STEP 2/3: LIST ASSIGNMENTS</h1>

        <div style={styles.sectionHeading}>
          EVALUABLE ASSIGNMENTS WITH ASSOCIATED RUBRIC (Course: {course.name})
        </div>

        <div style={styles.noteBox}>
          <strong>RF39 Note:</strong> Only assignments with an associated rubric in Canvas are listed below. Data retrieved via REST API.
        </div>
          ...
          <table style={styles.table}>
            <thead>
              <tr>
                ...
                <th style={{ ...styles.th, width: "15%", textAlign: "center" }}>Rubric Detected</th>
                <th style={{ ...styles.th, width: "25%" }}>Assigned Template</th>
                <th style={{ ...styles.th, width: "15%", borderRight: "none" }}>Plugin Active</th>
              </tr>
            </thead>
            <tbody>
                ...
                <tr key={item.id}>
                  ...
                  <td style={styles.td}>
                    <select style={styles.select} defaultValue={item.template}>
                      ...
                      <option value="Clase Standard">Clase Standard</option>
        ...
        <div style={{ marginTop: "30px", display: "flex", gap: "15px" }}>
          <button style={styles.btnCancel} onClick={onBack}>Back to Course Selection</button>
          <button style={styles.btnConfirm} onClick={onNext}>Continue to Step 3</button>
        </div>

        <WizardProgress currentStep={2} />
      </main>

      <StatusFooter lastSync="10:35:12" count={assignments.length} label="Assignment count" />
          ...
          <div style={styles.modalContent}>
            ...
            <div style={styles.modalBody}>
              ...
              <p style={{ marginTop: "15px", fontSize: "13px", color: "#666" }}>
                <strong>Nota RF40/CU40:</strong> Ya se ha seleccionado una plantilla para esta tarea. Todas las entregas de estudiantes sin un feedback generado ya no recibirán uno automáticamente. Ninguna nueva entrega activará un feedback hasta que se Reactiva.
              </p>
            </div>
