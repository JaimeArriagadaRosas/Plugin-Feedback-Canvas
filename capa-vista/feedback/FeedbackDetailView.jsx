  ...
  return (
    <div style={styles.wrapper}>
      <header style={styles.header}>
        <h1 style={styles.title}>VISTA DETALLADA DEL FEEDBACK - RF24/25</h1>
        <div style={{ fontSize: 11 }}>
          ESTUDIANTE → MODIFICAR (RF10, RF11) → SPEEDGRADER (RF16)
        </div>
      </header>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.cardBody}>
              ...
              <div style={{ display: "flex", gap: "10px", alignItems: "center", marginTop: "15px" }}>
                ...
                <div>
                  <strong>Trayectoria RF05:</strong>
          ...
          <div style={styles.card}>
            ...
            <div style={styles.cardBody}>
              <div style={{ fontSize: 12, color: "#666", marginBottom: "15px" }}>
                <strong>Estado RF24:</strong> Feedback visualizado para revisión.<br/>
                Personalización (RF05, RF03) Aplicada.<br/>
      ...
      <footer style={{ background: "#eee", padding: "10px 30px", fontSize: 12, borderTop: "1px solid #ddd" }}>
        Estado RF24: Visualizando feedback de {feedback?.student} (ID: JP123). Datos sincronizados de la base de datos local y Canvas API.
      </footer>
    </div>
  );
}
