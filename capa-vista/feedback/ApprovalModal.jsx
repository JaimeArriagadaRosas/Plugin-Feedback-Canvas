  ...
  return (
    <div style={styles.overlay}>
      <div style={styles.content}>
        <div style={styles.header}>APROBACIÓN Y REGISTRO DE FEEDBACK (RF26)</div>
          ...
          <div style={styles.leftCol}>
            ...
            <div style={styles.auditBox}>
              ...
              <div style={{ marginTop: "10px" }}>
                <strong>Acción:</strong> Aprobación y Publicación en Canvas (RF26)<br/>
        ...
        <div style={{ padding: "0 20px", fontSize: 11, color: "#666" }}>
          <strong>RF26:</strong> Feedback se guarda como comentario de rúbrica en Canvas. Se registran fecha, hora e ID de usuario en BD local.
        </div>
