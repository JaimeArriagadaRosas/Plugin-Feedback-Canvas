# HISTORICAL REFERENCE: This migration was originally intended for Canvas integration,
# but the plugin now uses standalone migrations in packages/plugin-database/migrations/
