...
async function simulate() {
  console.log('Simulando error: NOTIFICATION_FAILED');
  ...
  const payload = {
    ...
    tipo_error: 'NOTIFICATION_FAILED',
    mensaje_error: 'Fallo al enviar correo a alumno@correo.com: Connection refused'
  };
