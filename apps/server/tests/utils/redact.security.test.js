...
describe('redact.js Security', () => {
  it('Must redact sensitive parameters in a query string or URL', () => {
    const urls = [
    ...
    // Validate exact conservation of non-sensitive elements
  ...
  it('Must not affect other harmless parameters', () => {
