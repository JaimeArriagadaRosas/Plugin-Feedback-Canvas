export function generateLtiRubyScript({ ltiJson, pluginUrl, internalPluginUrl, canvasDomain, globalJsUrl }) {
  return `
    require 'json'
    ...
    if tool_config.respond_to?(:settings=)
      tool_config.settings = nil 
    end
