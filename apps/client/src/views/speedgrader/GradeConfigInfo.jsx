    ...
    <>
      <section className={styles.section}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--color-border)', paddingBottom: '6px' }}>
          <h3 className={styles.sectionTitle} style={{ borderBottom: 'none', paddingBottom: 0, margin: 0 }}>Grade and comments</h3>
          <button 
            onClick={toggleManualMode} 
            className={styles.manualToggleButton} 
            title={isManualMode ? 'Back to AI Feedback' : 'Manual Feedback Mode'}
      ...
      {!isManualMode && (
        <section className={styles.section}>
          <h3 className={styles.sectionTitle}>Detected configuration</h3>
          <div className={styles.configRow}>
            <span className={styles.configLabel}>Grade range:</span>
            <span className={styles.configValue}>{gradeRange}</span>
          </div>
          <div className={styles.configRow}>
            <span className={styles.configLabel}>Active template:</span>
