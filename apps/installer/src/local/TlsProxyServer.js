 ...
 *
 * Uso:
 *   node apps/installer/src/local/TlsProxyServer.js            # usa defaults (8443 -> 8080)
 *   TLS_LISTEN_PORT=8443 CANVAS_HTTP_PORT=8080 node apps/installer/src/local/TlsProxyServer.js
 *
...
// Ejecución directa: `node apps/installer/src/local/TlsProxyServer.js`
